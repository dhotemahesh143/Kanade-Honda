        ...
        <div className="mx-auto flex w-full max-w-[1750px] items-center gap-8 px-6 py-2.5 xl:px-12">
          ...
          <div className="ml-auto flex items-center gap-3 lg:ml-0">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="hidden items-center gap-2 bg-honda-red px-5 py-3 text-sm font-bold uppercase tracking-wider text-primary-foreground shadow-md transition hover:brightness-110 md:inline-flex"
            >
